...
class BoxesGame(ConnectionListener):
    ...
    def update(self):
        ...
        try: 
            if not (self.boardx[ypos][xpos] or self.boardo[ypos][xpos]): self.screen.blit(self.hoverlineo if self.playernum else self.hoverlinex, [xpos*100+12.5, ypos*100+12.5])
        except:
            isoutofbounds=True
            pass
